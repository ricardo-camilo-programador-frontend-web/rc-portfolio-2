...
export const Footer: FC<FooterProps> = memo(({ footer }) => {
  ...
  return (
    <footer ref={footerRef} className="reveal py-12 px-6 border-t border-white/5 bg-[#0A0A0A]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#E5D5C0]/80">
          © {currentYear} Ricardo Camilo. {footer.rights}
        </div>
