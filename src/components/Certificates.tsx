...
export const Certificates: FC<CertificatesProps> = memo(
  ({ title, subtitle, proficiency, certificate, level }) => {
    ...
    return (
      <section
        ref={sectionRef}
        className="reveal py-32 px-6 bg-[#0B0B0B]"
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 mt-12">
            <div className="space-y-2">
              ...
              <div className="text-[10px] uppercase tracking-widest text-[#E5D5C0]/80">{level}</div>
            </div>
          </div>
        </div>
      </section>
