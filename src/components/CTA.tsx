  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center" dir={isRtl ? 'rtl' : 'ltr'}>
        ...
        <p className="text-[#E5D5C0]/50 text-lg md:text-xl max-w-2xl mx-auto mb-16 leading-relaxed">
          {description}
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <motion.a
            ...
            className="px-12 py-5 rounded-full border border-white/10 text-[#E5D5C0] text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-white/5 transition-all flex items-center gap-3"
          >
            {whatsapp}
          </motion.a>
        </div>
