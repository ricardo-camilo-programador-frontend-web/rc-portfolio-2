...
import { Globe, ChevronDown, MessageCircle } from '../icons';
...
export const Navigation: FC<NavigationProps> = memo(({
  ...
  const handleLangSelect = useCallback((code: LanguageCode) => {
    setLangCode(code);
    setIsLangOpen(false);
  ...
  return (
    <>
      <a
        href="#main-content"
        className="skip-link z-[9999]"
        aria-label="Skip to main content"
      >
        Skip to main content
      </a>

      <div className="fixed top-0 left-0 right-0 h-1 bg-[#E5D5C0] origin-left z-[1000]" style={{ width: '100%' }} aria-hidden={true} />
      ...
      >
        <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
          ...
          <div className="hidden lg:flex gap-10 text-[9px] font-bold uppercase tracking-[0.3em] text-[#E5D5C0]/80" role="menubar" aria-label="Primary navigation menu">
            <a
              href="#work"
              ...
              role="menuitem"
              aria-current={typeof window !== 'undefined' && window.location.hash === '#work' ? 'page' : undefined}
            >
              {nav.work}
            </a>
            <a
              ...
              className="hover:text-[#E5D5C0] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E5D5C0] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A] rounded px-2 py-1"
              role="menuitem"
              aria-current={typeof window !== 'undefined' && window.location.hash === '#about' ? 'page' : undefined}
            >
              {nav.about}
            </a>
            <a
              ...
              className="hover:text-[#E5D5C0] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E5D5C0] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A] rounded px-2 py-1"
              role="menuitem"
              aria-current={typeof window !== 'undefined' && window.location.hash === '#services' ? 'page' : undefined}
            >
              {nav.services}
            </a>
            <a
              ...
              className="hover:text-[#E5D5C0] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E5D5C0] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A] rounded px-2 py-1"
              role="menuitem"
              aria-current={typeof window !== 'undefined' && window.location.hash === '#career' ? 'page' : undefined}
            >
              {nav.career}
            </a>
          </div>
